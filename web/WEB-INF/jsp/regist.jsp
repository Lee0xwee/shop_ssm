        ...
        $(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data == "null") {
                            ...
                            $("#usernameSpan").html("<font style='color: red;font-size: 15px'>用户名不能为空！</font>");


                        } else if (data == "fail") {

                            $("#usernameSpan").html("<font style='color: red;font-size: 15px'>用户名已经存在</font>");

                        } else {

                            $("#usernameSpan").html("<font style='color: green;font-size: 15px'>用户名可用</font>");
                        }
                    }
            ...
            $("#email").blur(function () {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: '${pageContext.request.contextPath}/user/checkEmail.action',
                    dataType: 'text',
                    data: 'email=' + $("#email").val(),
                    success: function (data) {
                        if (data == "null") {

                            $("#emailSpan").html("<font style='color: red;font-size: 15px'>邮箱不能为空！</font>");
                        }
                        else if (data == "fail") {

                            $("#emailSpan").html("<font style='color: red;font-size: 15px'>邮箱已注册!</font>");

                        } else {

                            $("#emailSpan").html("<font style='color: green;font-size: 15px'>邮箱可用</font>");
            ...
            $("#repassword").blur(function () {
                ...
                if ($.trim(pwd) != $.trim(repwd)) {
                    ...
                    $("#repasswordSpan").html("<font style='color: red;font-size: 15px'>两次密码不一致！</font>")
    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm" action="${pageContext.request.contextPath}/user/regist.action"
