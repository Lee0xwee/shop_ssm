...
<div class="container productContent">
    ...
    <div class="span18 last">
        <form id="cartForm" action="${pageContext.request.contextPath}/cart/addCart.action?pid=${product.pid}"
              method="post">
            ...
            <div class="info">
                ...
                <dl>
                    <dt>促销:</dt>
                    <dd>
                        <a target="_blank" title="限时抢购 (2019-08-22 ~ 2019-09-01)">限时抢购</a>
                    </dd>
                </dl>
                <dl>
                    <dt></dt>
...
<div class="container footer">
    <div class="span24">
        <div class="footerAd">
            <img src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/image/r_renleipic_01/footer.jpg"
