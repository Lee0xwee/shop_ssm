...
<div class="container cart">
    ...
    <div class="span24">
        ...
        <div class="step step1" style="text-align: left;padding-left: 10px">
            <span style="font-size: 30px;font-family: 'Times New Roman'; color: red">订单生成</span>
        </div>
        ...
        <form id="orderForm" action="./order_payOrder.action" method="post">
            ...
            <div class="span24">
                <p>
                    收货地址：<input name="order.user.addr" type="text" value="${sessionScope.sessionUser.addr}"
                                style="width:350px"/>
                    <br/>
                    收货人&nbsp;&nbsp;&nbsp;：<input name="order.user.username" type="text"
                                                 value="${sessionScope.sessionUser.username}" style="width:150px"/>
                    <br/>
                    联系方式：<input name="order.user.phone" type="text" value="${sessionScope.sessionUser.phone}"
                                style="width:150px"/>
